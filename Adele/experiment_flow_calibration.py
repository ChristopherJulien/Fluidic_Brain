...
def experiment(flow_rates,pump,syringe,runtime=15,flow_meter=None):
...
if __name__=="__main__":
    ...
    volume = pump_flow_rates * runtime / 1000  # Calculate the volume based on pump flow rates and runtime (ml)
