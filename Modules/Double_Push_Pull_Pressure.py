...
​
        ...
        for p_0 in p_range1:
            ...
            for p_1 in p_range2:
                ...
                fgt_set_pressure(1, p_1)
                print("Pressure Set to p_0 = {:0.2f} mbar and p_1 = {:0.2f} mbar".format(
                    p_0, p_1), end="\r")
    ...
    def experiment_cycle_double_controller(self, dict):
        ...
        ramp = Pressure_Controller(nb_controllers, exp_folder)
        with Pressure_Controllers_Setup(nb_controllers=ramp.nb_controllers):
            nstep1_up1 = abs(int((max_p1 - start_p1)/nb_steps1))+1
            # max_p1 = start_p1 + nb_steps1*(nstep1_up1-1)
            # nstep1_down1 = abs(int((max_p1 - min_p1)/nb_steps1))+1
            # min_p1 = max_p1 - nb_steps1*(nstep1_down1)
            # nstep1_up2 = - nstep1_up1 + nstep1_down1+1

            nstep2_up1 = abs(int((max_p2 - start_p2)/nb_steps2))+1
            # max_p2 = start_p2 + nb_steps2*(nstep2_up1-1)
            # nstep2_down1 = abs(int((max_p2 - min_p2)/nb_steps2))+1
