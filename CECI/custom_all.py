...
class TestApp(customtkinter.CTk):
    ...
    def create_widgets_on_ctk_frame(self):
        ...
        self.ctk_frame = customtkinter.CTkFrame(
            master=self, width=300, height=600)
        self.ctk_frame.place(x=x, y=y, anchor=tkinter.N)

        self.label_2 = customtkinter.CTkLabel(
            master=self.ctk_frame, text="create_widgets_on_ctk_frame", fg_color="gray50", width=200)
        self.label_2.place(relx=0.5, y=y, anchor=tkinter.CENTER)

        self.frame_2 = customtkinter.CTkFrame(
            master=self.ctk_frame, width=200, height=60)
        self.frame_2.place(relx=0.5, y=y + 80, anchor=tkinter.CENTER)

        self.button_2 = customtkinter.CTkButton(
            master=self.ctk_frame, border_width=3)
        ...
        self.slider_2 = customtkinter.CTkSlider(
            master=self.ctk_frame, command=lambda v: self.label_2.configure(text=str(round(v, 5))))
    ...
    def create_widgets_on_ctk_frame_customized(self):
        ...
        self.ctk_frame_customized = customtkinter.CTkFrame(
            master=self, width=300, height=600)
    ...
    def create_widgets_on_tk_frame_customized(self):
        ...
        self.frame_4 = customtkinter.CTkFrame(
        ...
        self.button_4.configure(border_color=(
            "#4F90F8", "#6FADF9"), hover_color=("#3A65E8", "#4376EE"))
        ...
        self.slider_4 = customtkinter.CTkSlider(
            master=self.tk_frame_customized, command=self.change_frame_color, from_=0, to=10)
        self.slider_4.place(relx=0.5, y=y + 400, anchor=tkinter.CENTER)
        self.slider_4.configure(button_color="#8AE0C3", fg_color=(
            "#EBECF3", "#4B577E"), progress_color=("gray30", "gray10"))
